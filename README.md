...
灵感来自于 [MisakaFxxk/Go\_stream](https://github.com/MisakaFxxk/Go_stream) ， [bpking1/embyExternalUrl](https://github.com/bpking1/embyExternalUrl)和[Nolovenodie](https://github.com/Nolovenodie)/[emby-direct](https://github.com/Nolovenodie/emby-direct)。
...
```
1 使用docekrfile编译镜像，例如为xxx

2 配置docker-compose.yml文件，将xxx添入image

3 配置.env.example文件，并重命名为.env，保证.env与docker-compose.yml位于同一目录
...
!\[图片]\(<https://github.com/user-attachments/assets/b661e6ae-e7b3-4be7-9c4f-7a86b02174ca> null)
